...
def ElementNameDummy():
    ElementNames = ("X H He Li Be B C N O F Ne Na Mg Al Si P S Cl Ar K Ca Sc "
...
class FAtomSet(object):
    ...
    def __getitem__(self,key):
        return FAtom(self.Elements[key], self.Pos[:,key], key)
