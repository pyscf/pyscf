...
class KnowValues(unittest.TestCase):
    ...
    def test_convert_to_scf(self):
        ...
        scf.addons.convert_to_rhf(scf.RHF(mol).density_fit().x2c())
        scf.addons.convert_to_uhf(scf.RHF(mol).density_fit().x2c())
        scf.addons.convert_to_ghf(scf.RHF(mol).density_fit().x2c())
        scf.addons.convert_to_rhf(scf.UHF(mol).density_fit().x2c())
        scf.addons.convert_to_uhf(scf.UHF(mol).density_fit().x2c())
        scf.addons.convert_to_ghf(scf.UHF(mol).density_fit().x2c())
        #scf.addons.convert_to_rhf(scf.GHF(mol).density_fit().x2c())
