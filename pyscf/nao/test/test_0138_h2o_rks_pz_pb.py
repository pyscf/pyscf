...
class KnowValues(unittest.TestCase):
  ...
  def test_138_h2o_rks_rpa_pb(self):
    ...
    np.savetxt('test_138_h2o_rks_pz_pb.txt', data.T, fmt=['%f','%f'])
    data_ref = np.loadtxt('test_138_h2o_rks_pz_pb.txt-ref').T
