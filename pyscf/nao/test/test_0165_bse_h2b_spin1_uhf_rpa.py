...
class KnowValues(unittest.TestCase):
  ...
  def test_165_bse_h2b_spin1_uhf_cis(self):
    """ This  """
    ...
    np.savetxt('test_0165_bse_h2b_spin1_uhf_rpa_pyscf.txt', data.T, fmt=['%f','%f'])
    data_ref = np.loadtxt('test_0165_bse_h2b_spin1_uhf_rpa_pyscf.txt-ref').T
    ...
    np.savetxt('test_0165_bse_h2b_spin1_uhf_rpa_nao.txt', data.T, fmt=['%f','%f'])
    data_ref = np.loadtxt('test_0165_bse_h2b_spin1_uhf_rpa_nao.txt-ref').T
    self.assertTrue(np.allclose(data_ref, data, atol=1e-6, rtol=1e-3))
