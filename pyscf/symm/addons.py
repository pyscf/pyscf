...
def symmetrize_multidim(mol, mo, s=None,
    ...
    Make coefficients of partner funtions of multidimensional irreps to be the same.
    ...
    Args:
        mol : an instance of :class:`Mole`
            Symmerty-adapted basis with multidimensional irreps should be generated by libmsym
        mo : 2D float array
            The orbital space to symmetrize
