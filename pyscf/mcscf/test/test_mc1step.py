...
class KnownValues(unittest.TestCase):
    ...
    def test_state_average(self):
        ...
        mc.fcisolver.spin = 2
        mc.run()
        self.assertAlmostEqual(mc.e_tot[0], -108.7513784239438, 9)
        self.assertAlmostEqual(mc.e_tot[1], -108.6919327057737, 9)
        self.assertAlmostEqual(mc.e_tot[2], -108.6919327057737, 9)
