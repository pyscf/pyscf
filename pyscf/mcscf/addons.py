...
def make_natural_orbitals (method_obj):
    ...
    if isinstance(rdm1, tuple):
        ...
        raise ValueError("\n\tThe rdm1 generated by method_obj.make_rdm1() was a {}.".format(type(rdm1))
            + 
            "\n\tThis type is not supported, please select a different method and/or open an issue at https://github.com/pyscf/pyscf/issues"
        )
