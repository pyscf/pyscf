...
from pyscf.ctfcc import kccsd_rhf, eom_kccsd_rhf
...
myip = eom_kccsd_rhf.EOMIP(mycc)
myea = eom_kccsd_rhf.EOMEA(mycc)

refip = cc.eom_kccsd_rhf.EOMIP(refcc)
refea = cc.eom_kccsd_rhf.EOMEA(refcc)
