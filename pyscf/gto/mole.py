...
#
# GTOIntegralMixin handed three layers of basis data: input, internal format, libcint arguments.
...
class Mole(GTOIntegralMixin, GlobalOptionMixin, lib.StreamObject):
    '''Molecule geometry data, GTO basis paramaters and global options
    ...
    def __init__(self, **kwargs):
        GTOIntegralMixin.__init__(self)
        GlobalOptionMixin.__init__(self)
        if kwargs:
