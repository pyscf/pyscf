...
class KnownValues(unittest.TestCase):
    def test_with_df(self):
        ...
        self.assertAlmostEqual(lib.finger(numpy.array(eris.oooo)), 4.962033460861587 , delta=1e-11)
        self.assertAlmostEqual(lib.finger(numpy.array(eris.ovoo)),-1.3666078517246127, delta=1e-12)
        self.assertAlmostEqual(lib.finger(numpy.array(eris.oovv)), 55.122525571320871, delta=1e-11)
        self.assertAlmostEqual(lib.finger(numpy.array(eris.ovvo)), 133.48517302161068, delta=1e-12)
        self.assertAlmostEqual(lib.finger(numpy.array(eris.ovvv)), 59.418747028576142, delta=1e-11)
        self.assertAlmostEqual(lib.finger(numpy.array(eris.vvvv)), 43.562457227975969, delta=1e-12)
