...
class KnownValues(unittest.TestCase):
    ...
    def test_dump_chk(self):
        ...
        cc1.dump_chk()
        cc1 = cc.RCCSDTQ(mf)
        cc1.__dict__.update(lib.chkfile.load(cc1.chkfile, 'rccsdtq'))
    ...
    def test_blksize(self):
        ...
        # cc3.blksize = 1
        # cc3.kernel()
        # self.assertAlmostEqual(cc3.e_corr, -0.04958398899351724, 7)
    ...
    def test_vector_to_amplitudes_overwritten(self):
        mol = gto.M()
        mycc = scf.RHF(mol).apply(rccsdtq.RCCSDTQ)
        nelec = (3, 3)
        nocc, nvir = nelec[0], 4
        nmo = nocc + nvir
        mycc.nocc = nocc
    ...
    def test_vector_size(self):
        self.assertEqual(mycc.vector_size(), 1470)
