...
class KnownValues(unittest.TestCase):
    ...
    def test_ucc_update_amps(self):
        ...
        self.assertAlmostEqual(abs(u1g[0]-t1[0]).max(), 0, 8)
        self.assertAlmostEqual(abs(u1g[1]-t1[1]).max(), 0, 8)
        self.assertAlmostEqual(abs(u2g[0]-t2[0]).max(), 0, 8)
        self.assertAlmostEqual(abs(u2g[1]-t2[1]).max(), 0, 8)
        self.assertAlmostEqual(abs(u2g[2]-t2[2]).max(), 0, 8)
        ...
        self.assertAlmostEqual(lib.finger(cc.addons.spatial2spin(t2, orbspin)), -10542.613510254763, 8)
