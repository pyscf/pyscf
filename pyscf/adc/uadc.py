...
################ Checking the the efficient incore code ###########
...
#
#        s[s_b:f_b] += np.einsum('icab,ibc->a',eris_OVVV, r_bbb_, optimize = True)
#        s[s_b:f_b] -= np.einsum('ibac,ibc->a',eris_OVVV, r_bbb_, optimize = True)
