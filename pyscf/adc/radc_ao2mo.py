...
def transform_integrals_incore(myadc):
    ...
    if (myadc.method == "adc(2)-x" or myadc.method =="adc(2)-c" or myadc.method == "adc(2)-xc" or myadc.method == "adc(3)"):
...
def transform_integrals_df(myadc):
    ...
    eris.vooo = eris.feri1.create_dataset('vooo', (nvir,nocc,nocc,nocc), 'f8', chunks=(1,nocc,nocc,nocc))
