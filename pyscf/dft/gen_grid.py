...
def make_screen_index(mol, coords, relativity=0, shls_slice=None,
                      cutoff=CUTOFF, verbose=None):
...
# don't modify the following attributes, they are not input options
    ...
    make_screen_index = lib.module_method(make_screen_index,
                                          absences=['mol', 'coords', 'cutoff'])

    @lib.with_doc(make_mask.__doc__)
    def make_mask(self, mol=None, coords=None, relativity=0, shls_slice=None,
                  verbose=None):
        return self.make_screen_index(mol, coords, relativity, shls_slice,
