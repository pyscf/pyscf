...
# don't modify the following attributes, they are not input options
    ...
    def dft3c(self, method='b97-3c', **kwargs):
        '''Apply a composite 3c method (B97-3c or r2SCAN-3c) to this object.

        The method returns a new DFT3C object and does not modify the
        original object.  Density fitting can be applied before or after
        the 3c setup, e.g. ``mf.dft3c('b97-3c').density_fit().run()`` or
        ``mf.density_fit().dft3c('b97-3c').run()``.

        See :func:`pyscf.dft.dft3c.dft3c` for details.
        '''
        from pyscf.dft.dft3c import dft3c as dft3c_
        return dft3c_(self, method=method, **kwargs)
