...
def _uks_gga_wv2(rho0, rho1, fxc, kxc, weight):
    ...
    wvb[1:4] += ud_dd * a1b1 * rho0b[1:4] * 4
    wvb[1:4] += uu_dd * a1a1 * rho0b[1:4] * 4
    wvb[1:4] += ud_dd * b1b1 * rho0a[1:4] * 2
    wvb[1:4] += ud_ud * a1b1 * rho0a[1:4] * 2
...
def _uks_mgga_wv2(rho0, rho1, fxc, kxc, weight):
    ...
    wva[0] += u_dd * b1b1 * 2
    wva[0] += u_u_uu * rho1a[0] * a0a1 * 4
    wva[0] += u_u_ud * rho1a[0] * (a0b1 + b0a1) * 2
    wva[0] += u_u_dd * rho1a[0] * b0b1 * 4
    wva[0] += u_d_uu * rho1b[0] * a0a1 * 4
    wva[0] += u_d_ud * rho1b[0] * (a0b1 + b0a1) * 2
    wva[0] += u_d_dd * rho1b[0] * b0b1 * 4
    wva[0] += u_uu_uu * a0a1 * a0a1 * 4
    wva[0] += u_uu_ud * a0a1 * (a0b1 + b0a1) * 4
    wva[0] += u_uu_dd * a0a1 * b0b1 * 8
    wva[0] += u_ud_ud * (a0b1 + b0a1)**2
    wva[0] += u_ud_dd * b0b1 * (a0b1 + b0a1) * 4
    wva[0] += u_dd_dd * b0b1 * b0b1 * 4
    ...
    wva[1:4] += uu_uu * a0a1 * rho1a[1:4] * 8
    wva[1:4] += uu_ud * a0a1 * rho1b[1:4] * 4
    wva[1:4] += uu_ud * (a0b1 + b0a1) * rho1a[1:4] * 4
    wva[1:4] += uu_ud * a1b1 * rho0a[1:4] * 4
    wva[1:4] += uu_ud * a1a1 * rho0b[1:4] * 2
    wva[1:4] += uu_dd * b1b1 * rho0a[1:4] * 4
    wva[1:4] += uu_dd * b0b1 * rho1a[1:4] * 8
    wva[1:4] += ud_ud * (a0b1 + b0a1) * rho1b[1:4] * 2
    wva[1:4] += ud_ud * a1b1 * rho0b[1:4] * 2
    wva[1:4] += ud_dd * b0b1 * rho1b[1:4] * 4
    wva[1:4] += ud_dd * b1b1 * rho0b[1:4] * 2
    ...
    wva[1:4] += u_uu_uu * rho1a[0] * a0a1 * rho0a[1:4] * 8
    wva[1:4] += u_uu_ud * rho1a[0] * (a0b1 + b0a1) * rho0a[1:4] * 4
    wva[1:4] += u_uu_ud * rho1a[0] * a0a1 * rho0b[1:4] * 4
    wva[1:4] += u_uu_dd * rho1a[0] * b0b1 * rho0a[1:4] * 8
    wva[1:4] += u_ud_ud * rho1a[0] * (a0b1 + b0a1) * rho0b[1:4] * 2
    wva[1:4] += u_ud_dd * rho1a[0] * b0b1 * rho0b[1:4] * 4
    wva[1:4] += d_uu_uu * rho1b[0] * a0a1 * rho0a[1:4] * 8
    wva[1:4] += d_uu_ud * rho1b[0] * (a0b1 + b0a1) * rho0a[1:4] * 4
    wva[1:4] += d_uu_ud * rho1b[0] * a0a1 * rho0b[1:4] * 4
    wva[1:4] += d_uu_dd * rho1b[0] * b0b1 * rho0a[1:4] * 8
    wva[1:4] += d_ud_ud * rho1b[0] * (a0b1 + b0a1) * rho0b[1:4] * 2
    wva[1:4] += d_ud_dd * rho1b[0] * b0b1 * rho0b[1:4] * 4
    wva[1:4] += uu_uu_uu * a0a1 * a0a1 * rho0a[1:4] * 8
    wva[1:4] += uu_uu_ud * a0a1 * (a0b1 + b0a1) * rho0a[1:4] * 8
    wva[1:4] += uu_uu_ud * a0a1 * a0a1 * rho0b[1:4] * 4
    wva[1:4] += uu_uu_dd * a0a1 * b0b1 * rho0a[1:4] * 16
    wva[1:4] += uu_ud_ud * (a0b1 + b0a1)**2 * rho0a[1:4] * 2
    wva[1:4] += uu_ud_ud * a0a1 * (a0b1 + b0a1) * rho0b[1:4] * 4
    wva[1:4] += uu_ud_dd * (a0b1 + b0a1) * b0b1 * rho0a[1:4] * 8
    wva[1:4] += uu_ud_dd * a0a1 * b0b1 * rho0b[1:4] * 8
    wva[1:4] += uu_dd_dd * b0b1 * b0b1 * rho0a[1:4] * 8
    wva[1:4] += ud_ud_ud * (a0b1 + b0a1)**2 * rho0b[1:4]
    wva[1:4] += ud_ud_dd * (a0b1 + b0a1) * b0b1 * rho0b[1:4] * 4
    wva[1:4] += ud_dd_dd * b0b1 * b0b1 * rho0b[1:4] * 4
    ...
    wva[1:4] += fggt[2] * rho1a[5] * (a0b1 + b0a1) * rho0a[1:4] * 4         # uu_ud_u
    wva[1:4] += fggt[3] * rho1b[5] * a0a1 * rho0b[1:4] * 4                  # uu_ud_d
    wva[1:4] += fggt[3] * rho1b[5] * (a0b1 + b0a1) * rho0a[1:4] * 4         # uu_ud_d
    wva[1:4] += fggt[4] * rho1a[5] * b0b1 * rho0a[1:4] * 8                  # uu_dd_u
    wva[1:4] += fggt[5] * rho1b[5] * b0b1 * rho0a[1:4] * 8                  # uu_dd_d
    wva[1:4] += fggt[6] * rho1a[5] * (a0b1 + b0a1) * rho0b[1:4] * 2         # ud_ud_u
    wva[1:4] += fggt[7] * rho1b[5] * (a0b1 + b0a1) * rho0b[1:4] * 2         # ud_ud_d
    ...
    wva[5] += frgt[2 ] * rho1a[0] * (a0b1 + b0a1)       # u_ud_u
    wva[5] += frgt[4 ] * rho1a[0] * b0b1 * 2            # u_dd_u
    wva[5] += frgt[6 ] * rho1b[0] * a0a1 * 2            # d_uu_u
    wva[5] += frgt[8 ] * rho1b[0] * (a0b1 + b0a1)       # d_ud_u
    wva[5] += frgt[10] * rho1b[0] * b0b1 * 2            # d_dd_u
    wva[5] += fggt[0 ] * a0a1 * a0a1 * 2                # uu_uu_u
    wva[5] += fggt[2 ] * a0a1 * (a0b1 + b0a1) * 2       # uu_ud_u
    wva[5] += fggt[4 ] * a0a1 * b0b1 * 4                # uu_dd_u
    wva[5] += fggt[6 ] * (a0b1 + b0a1)**2 * .5          # ud_ud_u
    wva[5] += fggt[8 ] * (a0b1 + b0a1) * b0b1 * 2       # ud_dd_u
    wva[5] += fggt[10] * b0b1 * b0b1 * 2                # dd_dd_u
    wva[5] += fgtt[0] * a0a1 * rho1a[5] * 2             # uu_u_u
    wva[5] += fgtt[1] * a0a1 * rho1b[5] * 2             # uu_u_d
    wva[5] += fgtt[3] * (a0b1 + b0a1) * rho1a[5]        # ud_u_u
    wva[5] += fgtt[4] * (a0b1 + b0a1) * rho1b[5]        # ud_u_d
    ...
    wvb[0] += d_dd * b1b1 * 2
    wvb[0] += u_d_uu * rho1a[0] * a0a1 * 4
    wvb[0] += u_d_ud * rho1a[0] * (b0a1 + a0b1) * 2
    wvb[0] += u_d_dd * rho1a[0] * b0b1 * 4
    wvb[0] += d_d_uu * rho1b[0] * a0a1 * 4
    wvb[0] += d_d_ud * rho1b[0] * (b0a1 + a0b1) * 2
    wvb[0] += d_d_dd * rho1b[0] * b0b1 * 4
    wvb[0] += d_uu_uu * a0a1 * a0a1 * 4
    wvb[0] += d_uu_ud * a0a1 * (b0a1 + a0b1) * 4
    wvb[0] += d_uu_dd * b0b1 * a0a1 * 8
    wvb[0] += d_ud_ud * (b0a1 + a0b1)**2
    wvb[0] += d_ud_dd * b0b1 * (b0a1 + a0b1) * 4
    wvb[0] += d_dd_dd * b0b1 * b0b1 * 4
    ...
    wvb[1:4] += uu_dd * a0a1 * rho1b[1:4] * 8
    wvb[1:4] += ud_ud * a1b1 * rho0a[1:4] * 2
    wvb[1:4] += ud_ud * (b0a1 + a0b1) * rho1a[1:4] * 2
    wvb[1:4] += ud_dd * b1b1 * rho0a[1:4] * 2
    wvb[1:4] += ud_dd * a1b1 * rho0b[1:4] * 4
    wvb[1:4] += ud_dd * b0b1 * rho1a[1:4] * 4
    wvb[1:4] += ud_dd * (b0a1 + a0b1) * rho1b[1:4] * 4
    wvb[1:4] += dd_dd * b1b1 * rho0b[1:4] * 4
    wvb[1:4] += dd_dd * b0b1 * rho1b[1:4] * 8
    ...
    wvb[1:4] += u_uu_ud * rho1a[0] * a0a1 * rho0a[1:4] * 4
    wvb[1:4] += u_uu_dd * rho1a[0] * a0a1 * rho0b[1:4] * 8
    wvb[1:4] += u_ud_ud * rho1a[0] * (b0a1 + a0b1) * rho0a[1:4] * 2
    wvb[1:4] += u_ud_dd * rho1a[0] * b0b1 * rho0a[1:4] * 4
    wvb[1:4] += u_ud_dd * rho1a[0] * (b0a1 + a0b1) * rho0b[1:4] * 4
    wvb[1:4] += u_dd_dd * rho1a[0] * b0b1 * rho0b[1:4] * 8
    wvb[1:4] += d_uu_ud * rho1b[0] * a0a1 * rho0a[1:4] * 4
    wvb[1:4] += d_uu_dd * rho1b[0] * a0a1 * rho0b[1:4] * 8
    wvb[1:4] += d_ud_ud * rho1b[0] * (b0a1 + a0b1) * rho0a[1:4] * 2
    wvb[1:4] += d_ud_dd * rho1b[0] * b0b1 * rho0a[1:4] * 4
    wvb[1:4] += d_ud_dd * rho1b[0] * (b0a1 + a0b1) * rho0b[1:4] * 4
    wvb[1:4] += d_dd_dd * rho1b[0] * b0b1 * rho0b[1:4] * 8
    wvb[1:4] += uu_uu_ud * a0a1 * a0a1 * rho0a[1:4] * 4
    wvb[1:4] += uu_uu_dd * a0a1 * a0a1 * rho0b[1:4] * 8
    wvb[1:4] += uu_ud_ud * (b0a1 + a0b1) * a0a1 * rho0a[1:4] * 4
    wvb[1:4] += uu_ud_dd * b0b1 * a0a1 * rho0a[1:4] * 8
    wvb[1:4] += uu_ud_dd * (b0a1 + a0b1) * a0a1 * rho0b[1:4] * 8
    wvb[1:4] += uu_dd_dd * b0b1 * a0a1 * rho0b[1:4] * 16
    wvb[1:4] += ud_ud_ud * (b0a1 + a0b1)**2 * rho0a[1:4]
    wvb[1:4] += ud_ud_dd * b0b1 * (b0a1 + a0b1) * rho0a[1:4] * 4
    wvb[1:4] += ud_ud_dd * (b0a1 + a0b1)**2 * rho0b[1:4] * 2
    wvb[1:4] += ud_dd_dd * b0b1 * b0b1 * rho0a[1:4] * 4
    wvb[1:4] += ud_dd_dd * b0b1 * (b0a1 + a0b1) * rho0b[1:4] * 8
    wvb[1:4] += dd_dd_dd * b0b1 * b0b1 * rho0b[1:4] * 8
    ...
    wvb[1:4] += fggt[6 ] * rho1a[5] * (b0a1 + a0b1) * rho0a[1:4] * 2        # ud_ud_u
    wvb[1:4] += fggt[7 ] * rho1b[5] * (b0a1 + a0b1) * rho0a[1:4] * 2        # ud_ud_d
    wvb[1:4] += fggt[8 ] * rho1a[5] * (b0a1 + a0b1) * rho0b[1:4] * 4        # ud_dd_u
    wvb[1:4] += fggt[8 ] * rho1a[5] * b0b1 * rho0a[1:4] * 4                 # ud_dd_u
    wvb[1:4] += fggt[9 ] * rho1b[5] * (b0a1 + a0b1) * rho0b[1:4] * 4        # ud_dd_d
    ...
    wvb[5] += frgt[3 ] * rho1a[0] * (b0a1 + a0b1)       # u_ud_d
    wvb[5] += frgt[5 ] * rho1a[0] * b0b1 * 2            # u_dd_d
    wvb[5] += frgt[7 ] * rho1b[0] * a0a1 * 2            # d_uu_d
    wvb[5] += frgt[9 ] * rho1b[0] * (b0a1 + a0b1)       # d_ud_d
    wvb[5] += frgt[11] * rho1b[0] * b0b1 * 2            # d_dd_d
    wvb[5] += fggt[1 ] * a0a1 * a0a1 * 2                # uu_uu_d
    wvb[5] += fggt[3 ] * (b0a1 + a0b1) * a0a1 * 2       # uu_ud_d
    wvb[5] += fggt[5 ] * b0b1 * a0a1 * 4                # uu_dd_d
    wvb[5] += fggt[7 ] * (b0a1 + a0b1)**2 * .5          # ud_ud_d
    wvb[5] += fggt[9 ] * b0b1 * (b0a1 + a0b1) * 2       # ud_dd_d
    wvb[5] += fggt[11] * b0b1 * b0b1 * 2                # dd_dd_d
    wvb[5] += fgt[1] * a1a1                             # uu_d
    wvb[5] += fgt[3] * a1b1                             # ud_d
    wvb[5] += fgt[5] * b1b1                             # dd_d
    wvb[5] += fgtt[1] * a0a1 * rho1a[5] * 2             # uu_u_d
    wvb[5] += fgtt[2] * a0a1 * rho1b[5] * 2             # uu_d_d
    wvb[5] += fgtt[4] * (b0a1 + a0b1) * rho1a[5]        # ud_u_d
    wvb[5] += fgtt[5] * (b0a1 + a0b1) * rho1b[5]        # ud_d_d
