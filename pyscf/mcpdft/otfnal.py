...
OT_PRESET={
    ...
    # COF26: MC-PDFT on-top functional from FunctionalAgent.
    # Y. Chen, D. G. Truhlar, and X. He, arXiv:2605.06215.
    'COF26': {
        'xc_base': 'MGGA_X_M06_L + MGGA_X_MN15_L, MGGA_C_M06_L + MGGA_C_MN15_L',
        'ext_params': {
            203: np.array([3.6295828040839164e+00, -8.7342184852617444e-01,
            ...
            233: np.array([0.06, 0.0031, 0.00515088, 0.00304966,
                           ...
                           1.0822050295891493e-02, 0.0, 6.3572219904928395e-01,
                           -3.6759152092850980e-02, 9.4673482384342381e-02,
                           7.3055061467144173e-04, -1.6657618977217563e-03,
                           0.0, 1e-10]),
            260: np.array([3.2066805228503675e-01, -1.8316655910737716e-02,
            ...
            261: np.array([9.5326877108995611e-01, -1.4874880062016240e+00,
        ...
        'hyb': (0.3208952612412691, 0.3208952612412691, 0),
        'facs': (1.0, 1.0, 1.0, 1.0)
    },

    # MC26: M06-L-only on-top functional from FunctionalAgent.
    # Y. Chen, D. G. Truhlar, and X. He, arXiv:2605.06215.
    'MC26': {
        'xc_base': 'M06L',
        'ext_params': {
            203: np.array([1.2793598175048828e+01, 1.0464407205581665e+00,
            ...
            233: np.array([0.06, 0.0031, 0.00515088, 0.00304966,
                           ...
                           -4.9975846195593476e-04, 0.0, -1.0493528842926025e+00,
                           -3.4804373979568481e-02, 1.6264947131276131e-02,
                           7.8431163274217397e-05, 4.0581694338470697e-04,
                           0.0, 1e-10])
        },
