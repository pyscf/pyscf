                            ...
                            int *bas, int nbas, double *env)
{
        ...
        CVHFrkb_q_cond(&int2e_breit_ssp1sps2_spinor, NULL, opt->q_cond, ao_loc, atm, natm, bas, nbas, env); /// first lssl
        CVHFrkb_q_cond(&int2e_breit_sps1ssp2_spinor, NULL, opt->q_cond + nbas * nbas, ao_loc,
                            ...
                            int *bas, int nbas, double *env)
{
        ...
        CVHFrkb_q_cond(&int2e_breit_ssp1sps2_spinor, NULL, opt->q_cond, ao_loc, atm, natm, bas, nbas, env); /// only lssl
}
                            ...
                            int *bas, int nbas, double *env)
{
        ...
        CVHFrkb_q_cond(&int2e_breit_sps1ssp2_spinor, NULL, opt->q_cond, ao_loc, atm, natm, bas, nbas, env); /// only slls
}
