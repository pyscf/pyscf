...
class KnownValues(unittest.TestCase):
    ...
    def test_dfuagf2_beh_ground_state(self):
        ...
        self.assertAlmostEqual(self.gf2.e_1b,  -15.0696810889066    , 4)
        self.assertAlmostEqual(self.gf2.e_2b,  -0.04953132465388112 , 4)
    ...
    def test_dfuagf2_beh_ip(self):
        ...
        self.assertAlmostEqual(e_ip[0], 0.2997045882193411, 4)
        self.assertAlmostEqual(e_ip[1], 0.5061695884140355, 4)
        self.assertAlmostEqual(e_ip[2], 0.5284717393681077, 4)
        self.assertAlmostEqual(v_ip[0], 0.9960125215054924, 4)
        self.assertAlmostEqual(v_ip[1], 0.9758519647601754, 4)
        self.assertAlmostEqual(v_ip[2], 0.9790675232737558, 4)
    ...
    def test_dfuagf2_beh_ea(self):
        ...
        self.assertAlmostEqual(e_ea[0], 0.04238166572514309, 4)
        self.assertAlmostEqual(e_ea[1], 0.04402081113588716, 4)
        self.assertAlmostEqual(e_ea[2], 0.04402081113588819, 4)
        self.assertAlmostEqual(v_ea[0], 0.9808256857147465 , 4)
        self.assertAlmostEqual(v_ea[1], 0.9917595650497684 , 4)
        self.assertAlmostEqual(v_ea[2], 0.9917595650497666 , 4)
