...
class KnowValues(unittest.TestCase):
    ...
    def test_density(self):
        ...
        diff_norm = numpy.linalg.norm(self.rdm1_rhf - rdm_loc)
        self.assertAlmostEqual(diff_norm, 0.0, delta=1.0e-12)
    ...
    def test_orth(self):
        ...
        diff_norm = numpy.linalg.norm(smo - numpy.eye(self.nocc))
        self.assertAlmostEqual(diff_norm, 0.0, delta=1.0e-12)
