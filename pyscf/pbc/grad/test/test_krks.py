...
class KnownValues(unittest.TestCase):
    ...
    def test_lda_grad(self):
        ...
        g = g_scan(cell)[1]
        self.assertAlmostEqual(finger(g), 0.10479318750495886, 6)
    ...
    def test_gga_grad(self):
        ...
        g_scan = mf.nuc_grad_method().as_scanner()
        g = g_scan(cell)[1]
        self.assertAlmostEqual(finger(g), 0.09636721236694831, 6)
    ...
    def test_hybrid_grad(self):
        ...
        g_scan = mf.nuc_grad_method().as_scanner()
        g = g_scan(cell)[1]
        self.assertAlmostEqual(finger(g), 0.11352022183481741, 6)
