...
if __name__ == '__main__':
    ...
    print("vj1 == vj2 ?", np.allclose(vj1,vj2))
    print("vk1 == vk2 ?", np.allclose(vk1,vk2))
    ...
    #         if abs(vj1[i,j]-vj[i,j]) > 1e-8:
    #             print("vj1[%3d,%3d] = %12.8f, vj[%3d,%3d] = %12.8f, ratio = %12.8f" % (i,j,vj1[i,j],i,j,vj[i,j],
    #                                                                                    vj1[i,j]/vj[i,j]))

    # for i in range(vk.shape[0]):
    #     for j in range(vk.shape[1]):
    #         if abs(vk1[i,j]-vk[i,j]) > 1e-8:
    #             print("vk1[%3d,%3d] = %12.8f, vk[%3d,%3d] = %12.8f" % (i,j,vk1[i,j],i,j,vk[i,j]))
    ...
    print("vj1 == vj_df ?", np.allclose(vj1,vj_df))
    print("vk1 == vk_df ?", np.allclose(vk1,vk_df))

    # for i in range(vj.shape[0]):
    #     for j in range(vj.shape[1]):
    #         if abs(vj1[i,j]-vj[i,j]) > 1e-8:
    #             print("vj1[%3d,%3d] = %12.8f, vj[%3d,%3d] = %12.8f, vj_df[%3d,%3d] = %12.8f" %
    #                   (i,j,vj1[i,j],i,j,vj[i,j],i,j,vj_df[i,j]))
