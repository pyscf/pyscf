...
if __name__ == '__main__':
    from pyscf import gto, dft, tddft, gw
    ...
    from pyscf.pbc import gto as pbc_gto, dft as pbc_dft, tdscf as pbc_tdscf
    cell = pbc_gto.Cell()
    cell.verbose = 5
    cell.atom = "He 0 0 0"
    cell.basis = 'gth-dzvp'
    cell.pseudo = "gth-pade"
    cell.a = "5 0 0; 0 5 0; 0 0 5"
    cell.unit = "Angstrom"
    cell.get_scaled_kpts

    kmf = pbc_dft.RKS(cell)
    kmf.kernel()

    ktd = pbc_tdscf.TDDFT(kmf)
    ktd.kernel()

    print("Molecular treatment:")
    print(" DFT:   {}".format(mf.mo_energy))
    print(" GW:    {}".format(gw.mo_energy))
    print("Periodic treatment:")
    print(" DFT:   {}".format(kmf.mo_energy))
