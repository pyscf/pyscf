        ...
        for iterkk, kk in enumerate(ranges0):
            for iterkl, kl in enumerate(ranges1):
                for iterki, ki in enumerate(ranges2):
                    ...
                    oooo_tmp[iterkk,iterkl,iterki] = np.array(eris.oooo[kk,kl,ki])
        ...
        for ka in ranges0:
            for kc in ranges1:
                for kb in range(ka+1):
                    ...
                    vvvv_tmp = np.array(eris.vvvv[ka,kb,kc])
        ...
        for iterkk, kk in enumerate(ranges0):
            for iterka, ka in enumerate(ranges1):
                for iterki, ki in enumerate(ranges2):
                    ...
                    ovov_tmp[iterkk,iterka,iterki] = np.array(eris.ovov[kk,ka,ki])
        ...
        for iterkk,kk in enumerate(ranges0):
            for iterkb,kb in enumerate(ranges1):
                for iterki,ki in enumerate(ranges2):
                    ...
                    ovoo_tmp[iterkk,iterkb,iterki] = np.array(eris.ovoo[kk,kb,ki])
