...
RETURN_VALUE=0
NODE_SCRATCHDIR="/lscratch/ccprak16/coronene_s1_$PBS_JOBID"
NODE_WORKDIR="/scratch/ccprak16/coronene_s1_$PBS_JOBID"
...
python coronene_s1.py > $NODE_WORKDIR/coronene_s1.py.out
echo "Finished job execution!"

echo "Copying files to final directory..."
cp $NODE_WORKDIR/coronene_s1.py.out $PBS_O_WORKDIR
