...
RETURN_VALUE=0
NODE_SCRATCHDIR="/lscratch/ccprak16/coronene_s3_$PBS_JOBID"
NODE_WORKDIR="/scratch/ccprak16/coronene_s3_$PBS_JOBID"
...
python coronene_s3.py > $NODE_WORKDIR/coronene_s3.py.out
echo "Finished job execution!"

echo "Copying files to final directory..."
cp $NODE_WORKDIR/coronene_s3.py.out $PBS_O_WORKDIR
