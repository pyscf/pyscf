...
RETURN_VALUE=0
NODE_SCRATCHDIR="/lscratch/ccprak16/azapentacene_s1_$PBS_JOBID"
NODE_WORKDIR="/scratch/ccprak16/azapentacene_s1_$PBS_JOBID"
...
python azapentacene_s1.py > $NODE_WORKDIR/azapentacene_s1.py.out
echo "Finished job execution!"

echo "Copying files to final directory..."
cp $NODE_WORKDIR/azapentacene_s1.py.out $PBS_O_WORKDIR
