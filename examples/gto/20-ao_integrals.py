...
s1 = mol.intor('cint1e_ipovlp_sph')  # (3,N,N) array, 3 for x,y,z components
t1 = mol.intor('cint1e_ipkin_sph' )  # (3,N,N) array, 3 for x,y,z components
v1 = mol.intor('cint1e_ipnuc_sph' )  # (3,N,N) array, 3 for x,y,z components

print('Dipole %s' % numpy.einsum('xij,ij->x', mol.intor('cint1e_r_sph'), dm))
