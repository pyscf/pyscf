...
CASSCF initial guess is generated by sort_mo function.  At beginning, we
selected the active space instead of the default canonical Hartree-Fock HOMO
LUMO orbitals because of the orbital symmetry.
'''
