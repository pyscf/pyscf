subroutine nr_vhf_grad_O00(dm, vj, vk, ndim, atm, natm, bas, nbas, env)
!**************************************************
  use cint_const_mod
  use cint_interface
  use hf_block_mod
...
! ==========
!
!  non-relativistic HF coulomb and exchange potential
...
!==================================================
  ...
  call cint2e_ip1_sph(fijkl, shls, atm, natm, bas, nbas, env, 0_8)
  do i = 1, 3
  ...
  deallocate (ao_loc)
  return
end subroutine nr_vhf_grad_O00
