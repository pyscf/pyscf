...
REAL_SPHERIC = (
    ...
    ('y(3x^2-y^2)', 'xyz', 'yz^2', 'z^3', \
     'xz^2', 'z(x^2-y^2)', 'x(x^2-3y^2)'), \
    ('-4', '-3', '-2', '-1', ' 0', ' 1', ' 2', ' 3', ' 4'),
)
...
ELEMENTS = (
        ...
        ('Mo'   , 98  , (10,18,14, 0,)),               # 42
        ('Tc'   , 98  , (10,18,15, 0,)),               # 43
        ('Ru'   , 102 , (10,18,16, 0,)),               # 44
        ('Rh'   , 103 , (10,18,17, 0,)),               # 45
        ('Pd'   , 106 , (10,18,18, 0,)),               # 46
        ('Ag'   , 107 , (10,18,19, 0,)),               # 47
        ...
        ('Pt'   , 195 , (12,24,28,14,)),               # 78
        ('Au'   , 197 , (12,24,29,14,)),               # 79
        ('Hg'   , 202 , (12,24,30,14,)),               # 80
        ('Tl'   , 205 , (12,24,30,14,)),               # 81
        ('Pb'   , 208 , (12,25,30,14,)),               # 82
        ('Bi'   , 209 , (12,26,30,14,)),               # 83
        ('Po'   , 209 , (12,27,30,14,)),               # 84
        ('At'   , 210 , (12,28,30,14,)),               # 85
        ('Rn'   , 222 , (12,29,30,14,)),               # 86
        ('Fr'   , 223 , (12,30,30,14,)),               # 87
        ('Ra'   , 226 , (13,30,30,14,)),               # 88
        ('Ac'   , 227 , (14,30,30,14,)),               # 89
        ('Th'   , 232 , (90, 0, 0, 0,)),               # 90
        ('Pa'   , 231 , (91, 0, 0, 0,)),               # 91
        ('U'    , 238 , (92, 0, 0, 0,)),               # 92
        ('Np'   , 237 , (93, 0, 0, 0,)),               # 93
