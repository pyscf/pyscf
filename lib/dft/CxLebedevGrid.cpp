...
static void SphGenOh(double *AIC_RP g, unsigned &num, int code, double &a, double &b, double v)
{
   double
      c;
   switch(code) {
...
static void MakeAngularGrid_6(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
   v = 0.1666666666666667e+0;
   SphGenOh(&pOut[N][0], N, 0, a, b, v);
}


static void MakeAngularGrid_14(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
   ...
   SphGenOh(&pOut[N][0], N, 2, a, b, v);
}


static void MakeAngularGrid_26(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
   ...
   SphGenOh(&pOut[N][0], N, 1, a, b, v);
   v = 0.3214285714285714e-1;
   SphGenOh(&pOut[N][0], N, 2, a, b, v);
}


static void MakeAngularGrid_38(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
   ...
   SphGenOh(&pOut[N][0], N, 4, a, b, v);
}


static void MakeAngularGrid_50(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
   ...
   SphGenOh(&pOut[N][0], N, 3, a, b, v);
}


static void MakeAngularGrid_74(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_86(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_110(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_146(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
   ...
   SphGenOh(&pOut[N][0], N, 5, a, b, v);
}


static void MakeAngularGrid_170(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_194(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_230(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_266(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_302(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_350(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_434(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_590(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_770(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_974(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_1202(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_1454(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_1730(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_2030(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_2354(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_2702(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_3074(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_3470(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_3890(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_4334(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_4802(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_5294(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
...
static void MakeAngularGrid_5810(double (*pOut)[4], unsigned &N)
{
   double
      a, b, v;
   N = 0;
   ...
   unsigned MakeAngularGrid(double (*pOut)[4], unsigned nPoints)
   {
      ...
      switch( nPoints ) {
         case 0:    pOut[0][0] = 0.0;  // x
                    ...
                    N = 1;
                    break;
         case 6:    MakeAngularGrid_6(pOut, N); break;
         case 14:   MakeAngularGrid_14(pOut, N); break;
         case 26:   MakeAngularGrid_26(pOut, N); break;
         case 38:   MakeAngularGrid_38(pOut, N); break;
         case 50:   MakeAngularGrid_50(pOut, N); break;
         case 74:   MakeAngularGrid_74(pOut, N); break;
         case 86:   MakeAngularGrid_86(pOut, N); break;
         case 110:  MakeAngularGrid_110(pOut, N); break;
         case 146:  MakeAngularGrid_146(pOut, N); break;
         case 170:  MakeAngularGrid_170(pOut, N); break;
         case 194:  MakeAngularGrid_194(pOut, N); break;
         case 230:  MakeAngularGrid_230(pOut, N); break;
         case 266:  MakeAngularGrid_266(pOut, N); break;
         case 302:  MakeAngularGrid_302(pOut, N); break;
         case 350:  MakeAngularGrid_350(pOut, N); break;
         case 434:  MakeAngularGrid_434(pOut, N); break;
         case 590:  MakeAngularGrid_590(pOut, N); break;
         case 770:  MakeAngularGrid_770(pOut, N); break;
         case 974:  MakeAngularGrid_974(pOut, N); break;
         case 1202: MakeAngularGrid_1202(pOut, N); break;
         case 1454: MakeAngularGrid_1454(pOut, N); break;
         case 1730: MakeAngularGrid_1730(pOut, N); break;
         case 2030: MakeAngularGrid_2030(pOut, N); break;
         case 2354: MakeAngularGrid_2354(pOut, N); break;
         case 2702: MakeAngularGrid_2702(pOut, N); break;
         case 3074: MakeAngularGrid_3074(pOut, N); break;
         case 3470: MakeAngularGrid_3470(pOut, N); break;
         case 3890: MakeAngularGrid_3890(pOut, N); break;
         case 4334: MakeAngularGrid_4334(pOut, N); break;
         case 4802: MakeAngularGrid_4802(pOut, N); break;
         case 5294: MakeAngularGrid_5294(pOut, N); break;
         case 5810: MakeAngularGrid_5810(pOut, N); break;
         default:
...
//    unsigned AngularGridSizes[32] = {6, 14, 26, 38, 50, 74, 86, 110, 146, 170, 194, 230, 266, 302, 350, 434, 590, 770, 974, 1202, 1454, 1730, 2030, 2354, 2702, 3074, 3470, 3890, 4334, 4802, 5294, 5810};
   FAngularGridEntry
      AngularGridInfo[nAngularGrids] = {
         ...
         {  21,  170, false},
         {  23,  194, false},
         {  25,  230, true }, // note: has negative weights
         {  27,  266, true }, // note: has negative weights
         {  29,  302, false},
         {  31,  350, false},
         {  35,  434, false},
         {  41,  590, false},
